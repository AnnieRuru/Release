...
HPExport void plugin_init (void) {
	...
	addScriptCommand( "setmf_movespeed", "si?", setmf_movespeed );
	addScriptCommand( "removemf_movespeed", "s", removemf_movespeed );
	addScriptCommand( "getmf_movespeed", "s?", getmf_movespeed );
}
