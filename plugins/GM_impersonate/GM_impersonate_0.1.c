...
//===== Topic ================================================
//= http://herc.ws/board/topic/7028-chat-space-limitationscammer-avoid-will-pay-for-help/?do=findComment&comment=42725
//===== Additional Comments: =================================  
//= take this as birthday gift :P
//============================================================
...
bool clif_process_message_spaces( int retVal, struct map_session_data *sd, int format, char **name_, size_t *namelen_, char **message_, size_t *messagelen_) {
	if ( retVal == true ) {
		if ( stristr( (char*)RFIFOP( sd->fd ,4) + strnlen(sd->status.name, NAME_LENGTH-1) + 3, "    " ) != NULL ) {
