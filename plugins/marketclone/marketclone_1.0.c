...
int status_percent_change_pre( struct block_list *src,struct block_list *target, signed char *hp_rate, signed char *sp_rate, int *flag ) {
...
HPExport void plugin_init (void) {
	...
	addHookPre( "status->percent_change", status_percent_change_pre );
}