...
ACMD(reloadonpcstatcalcevent) {
	int count = 0;
	char msg[CHAT_SIZE_MAX] = "Done reloading '@reloadonpcstatcalcevent' with %d entries.";
	clean_onpcstatcalcevent();
	count = read_onpcstatcalcevent();
...
HPExport void plugin_init(void) {
	...
	addAtcommand("reloadonpcstatcalcevent", reloadonpcstatcalcevent);
}
