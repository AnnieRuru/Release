...
HPExport void plugin_init (void) {
	...
	addScriptCommand( "setmf_fixedaspd", "si?", setmf_fixedaspd );
	addScriptCommand( "removemf_fixedaspd", "s", removemf_fixedaspd );
	addScriptCommand( "getmf_fixedaspd", "s?", getmf_fixedaspd );
}
